...
//var Links=$x("//a");
var Links=$x("//a[contains(@href,'rapid') or contains(@href,'hotfile')]");
if (Links && Links.length>0)
{
  Links.forEach(function (e) { 
    //GM_log(e.href);
    if (/.*:\/\/[^\/]*/.test(e.href))
      GM_log(e.href.match(/.*:\/\/[^\/]*/)[0]); 
  })
  createElement('div', { innerHTML:Links.map(function (e) { return e.href; }).join("<br>") },document.body);
}
