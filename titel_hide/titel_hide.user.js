...
// @namespace      Woems
// @include        *
// @require        http://userscripts.org/scripts/source/64404.user.js
// ==/UserScript==
...
switch (location.host)
{
  ...
  case "youtube.de":
    ...
    break;
  default:
    var t=deserialize("Title",{});
    if (!t[location.host]) t[location.host]=prompt(location.host,document.title);
    if (document.title==t[location.host]) t[location.host]="---";
    if (t[location.host]!="---") document.title=t[location.host];
    serialize("Title",t);
    break;
}
