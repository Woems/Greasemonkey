...
if (location.pathname=="/index.php" && location.search=="?page=TvAllInOne.php3")
{
  var min=60*1000;
  var hour=60*min;
  Timeout(function () { location.href="http://www.klack.de/index.php?page=TvAllInOne.php3"; },30*min);
}
