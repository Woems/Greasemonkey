// ==UserScript==
// @name           YouTube - Warteschlange aufraeumen
// @namespace      Woems
...
//GM_log=function (){}
/********************************/
//$("watch-sidebar").style.overflow="auto";
//$("watch-sidebar").style.height=(window.innerHeight-300)+"px";

/*
$("watch-video-container").style.position="fixed";
var pos=PosXY($("watch-video-container"));
pos.width=$("watch-video-container").width;
pos.height=$("watch-video-container").height;
GM_log(uneval(pos));
$("watch-video-container").style.top=pos.y+"px";
$("watch-video-container").style.left=pos.x+"px";
$("watch-video-container").style.zIndex="999";
*/
var gespielteVideos=$x('id("quicklist-tray-content")//li[contains(@class,"quicklist-item-playing")]/preceding::li[@data-video-id]//span[@class="yt-uix-button master-sprite delete"]');
//GM_log("len: "+gespielteVideos.length+"\nNum: "+gespielteVideos.map(function (e) { return e.getAttribute("data-video-id"); }).join(", "));
if (gespielteVideos && gespielteVideos.length>=5)
{
  //gespielteVideos[0].click();
  //GM_log("Lösche Video: "+gespielteVideos[0].getAttribute("data-video-id")+" und "+gespielteVideos[1].getAttribute("data-video-id"));
  //location.href="javascript:yt.www.watch.quicklist.onQuickDeleteClick('"+gespielteVideos[0].getAttribute("data-video-id")+"', undefined);"
  //if (gespielteVideos.length>5) location.href="javascript:yt.www.watch.quicklist.onQuickDeleteClick('"+gespielteVideos[1].getAttribute("data-video-id")+"', undefined);"
