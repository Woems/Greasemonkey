// ==UserScript==
// @name        Keenmedia Forum
// @namespace   Woems
// @include     http://board.keenmedia.de*
// @version     1
// ==/UserScript==
...
{
  case '/index.php': wer_ist_online(); break;
  case '/viewforum.php': wer_ist_online(); break;
  case '/viewtopic.php': thread_bewerten(); wer_ist_online(); break;
  default: alert("Kennmedia Forum: "+location.pathname); break;
}
...
function thread_bewerten()
{
  var Forum=getParam("f");
  var Topic=getParam("t");
  var Position=0;
  //alert([Forum, Topic].join("\n"));
  showmsg({
    id: "topic_bewerten",
    text: [Forum, Topic, "Gut?",''].join("<br>"),
    color: "lightgray",
    OK: "OK",
    Cancel: "Cancel",
    Timeout: 60,
    onOK: function (data) { var dataTopic=aget('data',getParam("t"))||{}; dataTopic.q=2; aset('data',getParam("t"),dataTopic); },
    onCancel: function (data) { var dataTopic=aget('data',getParam("t"))||{}; dataTopic.q=5; aset('data',getParam("t"),dataTopic); },
