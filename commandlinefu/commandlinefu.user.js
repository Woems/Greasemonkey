...
// @name        commandlinefu
// @namespace   Woems
// @description Zugriff auf die commandlinefu API
// @include     http://www.commandlinefu.com*
// @include     *
// @version     1
// ==/UserScript==
...
{
  //alert([uneval(data)].join("\n"));
  data=data.map(function (e) {
    //e.html="<b><a href='"+e.url+"'>"+e.id+"</a>: "+e.command+"</b><br>"+e.summary+"<br>"+e.votes;
    e.html="<b style='color:#4A4; font-family:inherit'>"+e.command+"</b><br>"+e.summary;
    return e;
  });
  //showmsg({ text: ObjKeys(data[0]), onOK: function (data) {}, });
  data.forEach(function (e) {
    var read=deserialize('read',{});
    if (!read[e.id])
    {
      css("#commandlinefu input { color:white; background-color:#555; border: 1px solid #777; border-radius:0.3em; padding: 0.1em }");
      showmsg({
        id: "commandlinefu",
        text: e.html+"<br>",
        color:"black",
