// ==UserScript==
// @name           WePad - Grosse Videos
// @namespace      Woems
// @include        http://wepad.mobi/galerie
// ==/UserScript==
...
$x("//embed | //object | //object/..").forEach(function (e) {
  if (e.width) e.width = e.width.replace("px","") * 2 + "px";
  if (e.height) e.height = e.height.replace("px","") * 2 + "px";
});
