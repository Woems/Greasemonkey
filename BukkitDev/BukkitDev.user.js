...
function ShowInfo() {
  ...
  $x('//tr/td/h2/a[@href]').forEach(function (a) {
    ...
    //showmsg({ text:id+data[id].seen, onOKTimeout:function (e) {} });

    if (data[id] && data[id].seen)
    {
      a.parentNode.parentNode.parentNode.style.backgroundColor="lightgray";
      a.textContent=a.textContent+" ("+Math.floor((Now()-data[id].seen)/60)+" min)";
    }
  });  
