...
{
  createElement('button', {type: 'button', id: 'g_saehen', style: 'position:fixed;top:0px;left:400px;width:100px;height:20px;', innerHTML:'S&auml;hen', onClick:alles_saehen}, document.body);
  createElement('button', {type: 'button', id: 'g_giessen', style: 'position:fixed;top:0px;left:500px;width:100px;height:20px;', innerHTML:'Gießen', onClick:alles_giessen}, document.body);
}
