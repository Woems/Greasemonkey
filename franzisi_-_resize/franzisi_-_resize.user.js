// ==UserScript==
// @name           franzisi - Resize
// @namespace      Woems
// @include        http://www.franzisi.com/shop/popup_image.php?*
// ==/UserScript==
...
unsafeWindow.popupWindow=function (url) {
  window.open(url,'popupImageWindow',
    'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=yes,copyhistory=no,width=610,height=800,screenX=150,screenY=150,top=150,left=150'); 
}
